...
//        method = new Method(VideoPlayer.this);
       ...
       // playerView.setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_FIT);
        ...
        player = ExoPlayerFactory.newSimpleInstance(Video_player.this, trackSelector);
        playerView.setPlayer(player);

        // Produces DataSource instances through which media data is loaded.
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(Video_player.this,
                Util.getUserAgent(Video_player.this, getResources().getString(R.string.app_name)));
        // This is the MediaSource representing the media to be played.
        MediaSource videoSource = new ExtractorMediaSource.Factory(dataSourceFactory)
                .createMediaSource(Uri.parse(video_url));
        HlsMediaSource hlsMediaSource =
                new HlsMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(video_url));
